  ...
  select: function(){
    ...
    setTimeout(function(){
      if (quiz.now < quiz.data.length) { quiz.draw(); } 
        ...
        quiz.hQn.innerHTML = `شما به  ${quiz.score} ریسک فاکتور از ${quiz.data.length} ریسک فاکتورهای مرتبط با پوکی استخوان که در این پرسشنامه مطرح شد، پاسخ مثبت داده‌اید!`;
        quiz.hAns.innerHTML = "پاسخ مثبت به هریک از سؤالات این پرسشنامه به این معنی است که شما از نظر پزشکی در معرض خطر ابتلا به پوکی استخوان و شکستگی قرار دارید.\
	      </br>پس از تکمیل پرسشنامه، در مورد ریسک فاکتورهای مثبت خود از پزشک متخصص کمک بگیرید. در صورت نیاز، پزشک انجام تست تراکم استخوان و یا استفاده از دارو را تجویز می‌کند و یا توصیه‌هایی برای اصلاح الگوی زندگی شما خواهد داشت.";
        quiz.hFn.innerHTML= "<strong>نکته:</strong> توجه داشته باشید که این تست صرفا برای افزایش آگاهی شما از خطر پوکی استخوان طراحی شده است. از این رو پرسشنامه حاضر جایگزینی برای تست‌های تشخیصی پوکی استخوان (نظیر BMD و یا FRAX) نمی‌باشد."
      }
    }, 1000);
  }
};
